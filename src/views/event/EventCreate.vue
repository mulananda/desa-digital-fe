...
import { eventFormSchema } from "@/schemas/event/event.schema";

import { useFormUX } from "@/utils/useFormUX";
import { validateWithZod } from "@/utils/validateWithZod";
import { extractBackendErrors } from "@/utils/extractBackendErrors";
import { useCreateEvent } from "@/composables/event/useCreateEvent";
...
const { mutate: submitEvent, isPending, isError, error } = useCreateEvent();
...
async function handleSubmit() {
  ...
  const result = validateWithZod(eventFormSchema, form);
      ...
      >
        ...
        <div class="flex-1">
          <InputFile
            ...
            upload-label="Tambah Thumbnail"
            change-label="Tambah Thumbnail"
        ...
        <div class="flex flex-1 gap-6 shrink-0">
          ...
          >
            <input
              ...
              @input="clearFieldError('is_active')"
            />
            <span
